"""Chinese prompts for EpisodeExtractor — verbatim port from new-release opensource.

Source: ``opensource/evermemos-opensource/src/memory_layer/prompts/zh/episode_mem_prompts.py``.
...
仅返回JSON对象，不要添加任何其他文本（生成的记忆必须与对话文本使用相同的语言）：
"""
