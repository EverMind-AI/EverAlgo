"""Skill ranker facade — thin wrapper over ``rerank._basic_arank``."""
...
class SkillRanker:
    ...
    async def arank(
        ...
        *,
        ...
        Returns:
            Ranked and optionally LLM-reranked skill items.
        """
...
async def arank(
    ...
    *,
    ...
    """Skill module-level ranker — delegates to ``rerank._basic_arank``."""
    return await _basic_arank(
        rank_input,
        config=config,
        llm=llm,
