"""Stub existence tests for evercore.rank."""

import inspect


def test_top_level_exports_seven_modules() -> None:
    from evercore.rank import __all__
...
def test_facade_modules_have_arank_or_rank() -> None:
    from evercore.rank import case, episodic, profile, skill
...
def test_fusion_tools_callable() -> None:
    from evercore.rank import fusion
...
def test_weight_tools_callable() -> None:
    from evercore.rank import weight
...
def test_rerank_dual_interface() -> None:
    from evercore.rank import rerank
