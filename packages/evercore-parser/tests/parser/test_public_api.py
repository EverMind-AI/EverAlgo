"""Stub existence tests for evercore.parser."""

import inspect


def test_top_level_routing_aparse_parse() -> None:
    from evercore.parser import aparse, parse
...
def test_five_submodules_have_dual_interface() -> None:
    from evercore.parser import audio, document, image, url, video
...
def test_dunder_all_lists_seven_symbols() -> None:
    from evercore.parser import __all__
