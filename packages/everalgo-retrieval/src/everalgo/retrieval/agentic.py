...
from everalgo.retrieval.prompts.en.multi_query import MULTI_QUERY_PROMPT_EN
from everalgo.retrieval.prompts.en.refined_query import REFINED_QUERY_PROMPT_EN
from everalgo.retrieval.prompts.en.sufficiency import SUFFICIENCY_CHECK_PROMPT_EN
...
async def aagentic_retrieve(
    ...
    *,
    ...
    The caller composes hybrid / hierarchical / single-route search as ``base_retrieve``;
